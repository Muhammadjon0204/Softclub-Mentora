 ...
 * scope одного Mentor (`useScopedMentorAssignments`, уже отфильтрован по
 * `mentorId`), без командных/team-метрик, которых у Mentor по ролевой
 * модели нет (ТЗ 8.4 — Mentor не видит показатели других менторов).
 */
