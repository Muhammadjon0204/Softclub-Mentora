...
const hqCsharpAssignments: LeadAssignmentRecord[] = [
  ...
  },
  {
    id: 'asn-hqcs-15',
    categoryId: HQ_CS,
    title: 'Работа с Redis: distributed lock',
    description: 'Реализовать распределённую блокировку на Redis (RedLock) для защиты от гонок при списании остатков.',
    status: 'InReview',
    source: 'Manual',
    mentorId: 'usr-1017',
    assignedById: leadHqCs,
    ...
    submissions: [
      {
        id: 'sub-hqcs-15-1',
        versionNumber: 1,
        submittedAt: now - 22 * H,
        isLate: false,
        comment: 'Проверил на трёх параллельных инстансах сервиса — блокировка держится корректно.',
        files: [file('f-hqcs-15-1', 'redis-distributed-lock.pdf', 'pdf', '1.5 МБ')],
        review: null,
      },
    ],
    events: [
      { id: 'ev-hqcs-15-1', kind: 'Assigned', occurredAt: now - 5 * D, actorName: leadHqCs, detail: 'Умед Раджабов' },
      { id: 'ev-hqcs-15-2', kind: 'SubmissionUploaded', occurredAt: now - 22 * H, actorName: 'Умед Раджабов', detail: 'Версия 1' },
      { id: 'ev-hqcs-15-3', kind: 'ReviewStarted', occurredAt: now - 1 * H, actorName: leadHqCs },
    ],
  },
  {
    id: 'asn-hqcs-16',
    categoryId: HQ_CS,
    title: 'Валидация входных данных FluentValidation',
    description: 'Перевести ручную валидацию DTO модуля заданий на FluentValidation, покрыть тестами граничные случаи.',
    status: 'Overdue',
    source: 'Manual',
    mentorId: 'usr-1017',
    assignedById: leadHqCs,
    ...
    submissions: [],
    events: [
      { id: 'ev-hqcs-16-1', kind: 'Assigned', occurredAt: now - 9 * D, actorName: leadHqCs, detail: 'Умед Раджабов' },
      { id: 'ev-hqcs-16-2', kind: 'MarkedOverdue', occurredAt: now - 2 * D, actorName: 'Система' },
    ],
  },
  {
    id: 'asn-hqcs-17',
    categoryId: HQ_CS,
    title: 'Интеграция с внешним платёжным шлюзом (sandbox)',
    description: 'Реализовать вызов sandbox-API платёжного шлюза и обработку webhook-уведомлений.',
    status: 'Cancelled',
    source: 'Manual',
    mentorId: 'usr-1017',
    assignedById: leadHqCs,
    topicAssignmentId: null,
    initialDueAt: now - 9 * D,
    currentDueAt: now - 9 * D,
    assignedAt: now - 13 * D,
    firstSubmittedAt: null,
    reviewStartedAt: null,
    approvedAt: null,
    overdueAt: null,
    cancelledAt: now - 11 * D,
    cancelReason: 'Партнёр сменил провайдера платежей — задание больше не актуально в текущей постановке.',
    allowLateSubmission: true,
    submissions: [],
    events: [
      { id: 'ev-hqcs-17-1', kind: 'Assigned', occurredAt: now - 13 * D, actorName: leadHqCs, detail: 'Умед Раджабов' },
      { id: 'ev-hqcs-17-2', kind: 'Cancelled', occurredAt: now - 11 * D, actorName: leadHqCs, detail: 'Партнёр сменил провайдера платежей — задание больше не актуально в текущей постановке.' },
    ],
  },
  {
    id: 'asn-hqcs-14',
